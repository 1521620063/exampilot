...
execSync(
  `npx esbuild background/index.js background/template-engine.js background/request-overrides.js background/settings-transfer.js background/query-ai.js ${minifyCli} --outdir=dist/chrome/background --outbase=background`,
  { cwd: root, stdio: 'inherit' }
);
