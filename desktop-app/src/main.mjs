...
function ConfigEditor(props) {
  ...
  return html`<div class="config-form">
    <label>名称<input value=${config.name || ''} onInput=${function (e) { update('name', e.currentTarget.value); }} /></label>
    <label>接口地址<input value=${config.url || ''} placeholder="https://api.example.com/v1/chat/completions" onInput=${function (e) { update('url', e.currentTarget.value); }} /></label>
    <label>模型<input value=${config.model || ''} onInput=${function (e) { update('model', e.currentTarget.value); }} /></label>
    <label>API Key<input type="password" value=${config.apiKey || ''} onInput=${function (e) { update('apiKey', e.currentTarget.value); }} /></label>
    ...
    <label>Headers JSON<textarea value=${config.customHeadersJson || ''} onInput=${function (e) { update('customHeadersJson', e.currentTarget.value); }} /></label>
    <label>Body JSON<textarea value=${config.customBodyJson || ''} onInput=${function (e) { update('customBodyJson', e.currentTarget.value); }} /></label>
